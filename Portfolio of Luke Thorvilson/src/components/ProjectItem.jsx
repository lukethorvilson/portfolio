...
function ProjectItem({ project }) {
  ...
  return (
    <div className="relative m-auto mb-6 grid w-[450px] grid-cols-1 gap-4 rounded-md border-8 bg-zinc-700 p-2 sm:w-[575px] md:w-[700px] lg:w-[995px] lg:grid-cols-2 xl:w-[1200px]">
      <div className="relative mx-auto h-[325px] w-[350px] sm:w-[500px] sm:h-[350px] md:h-[300px] md:w-[675px] lg:col-span-1 lg:w-[400px] lg:h-[400px] xl:w-[600px] xl:h-[500px]">
      ...
      <div className="relative mx-auto my-auto h-full w-[350px] sm:w-[450px] sm:h-[250px] md:h-[275px] md:w-[600px] lg:col-span-1 lg:h-[300px] lg:w-[450px] xl:w-[525px]">
        <img
